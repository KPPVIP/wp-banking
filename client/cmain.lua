WPCore = nil
TriggerEvent('WPCore:GetObject', function(obj) WPCore = obj end)
...
CreateThread(function()
	while WPCore == nil or WPCore.Functions.GetPlayerData() == nil or WPCore.Functions.GetPlayerData().money == nil or not docReady do
		Citizen.Wait(100)
	end
...
AddEventHandler('bb-banking:client:triggerAtm', function(data, nui, fees)
    if data.cards ~= nil and data.cards[1] ~= nil then
        ...
        WPCore.Functions.Notify("To use ATM you need to open a credit card", "error")
    end
end)
